...
/**
  ...
  *
  * @checksum - 4027289f8817e0218a5d81cdc392e981bbb19fc31b2a00734c37ae0fd72e56d8
  * @variables - radius=rounded,accentColor=purple,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
